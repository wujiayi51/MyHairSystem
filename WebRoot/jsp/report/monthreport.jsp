...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var keyword2 ;
		 $('#datetimepicker2').datetimepicker().on('changeDate', function(ev){//给输入框绑定按键事件
			//给输入框绑定按键事件
	...
	<div style="margin-top:30px;background-color: #E5E5E5;height:100%;border-radius:15px 0px 0px 0px;">
		<div class="app-title" style="background-color:transparent;margin-bottom:0px;">
			...
			<ul class="app-breadcrumb breadcrumb" style="font-size:15px;">
				...
				<li class="breadcrumb-item"><a href="#">利润报表</a>
				</li>
			</ul>

			<div>
				<button type="button" class="btn btn-primary click" onclick="window.location.href='<c:url value="/chart" />'">查看年度利润报表</button>
				<!-- <p>追寻风的气息  不顺畅  怎能飘逸 </p> -->
			</div>
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<div class='input-group date' id='datetimepicker'>
							<input type='text' class="form-control" id="selectdate" value="" placeholder="请选择开始月份"
