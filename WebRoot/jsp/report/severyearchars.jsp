...
<link rel="stylesheet" type="text/css" media="screen" href="<%=basePath%>styles/bootstrap.css">
<!-- 时间选择器 -->
	...
	<div style="margin-top:30px;background-color: #E5E5E5;height:100%;border-radius:15px 0px 0px 0px;">
		<div class="app-title" style="background-color:transparent;margin-bottom:0px;">
			...
			<ul class="app-breadcrumb breadcrumb" style="font-size:15px;">
				...
				<li class="breadcrumb-item"><a href="#">项目报表</a>
				</li>
			</ul>
			<div>
				<button type="button" class="btn btn-primary click" onclick="window.location.href='<c:url value="/echars/monthchart" />'">查看月份项目报表</button>
				<!-- <p>追寻风的气息  不顺畅  怎能飘逸 </p> -->
			</div>
		</div>
		...
		<div class='col-sm-3'>
			<div class="form-group">
				...
				<div class='input-group date' id='datetimepicker'>
					<input id="dateY" type='text' class="form-control" value="" placeholder="请输入年份" name="keyword" />
